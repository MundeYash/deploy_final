...
export default function Admin({ login }: OperatorProps) {
  ...
  const [selectedDuration, setSelectedDuration] = useState(""); // Initialize to an empty string
